...
{
    Serial.begin(9600);
    queue_h = xQueueCreate(10, sizeof(item_queue));
    xTaskCreate(task1, "task1", 1000, NULL, tskIDLE_PRIORITY, NULL);
    xTaskCreate(task2, "task2", 1000, NULL, tskIDLE_PRIORITY, NULL);
    vTaskStartScheduler();
}
